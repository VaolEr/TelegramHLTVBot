...
public class StatsByMatchIdCallbackQueryHandler implements CallbackQueryHandler {

    private static final CallbackQueryType HANDLER_QUERY_TYPE = BotCallbackQueryType.STATS;
    private final ReplyMessageService messageService;

    @Override
    public SendMessage handleCallbackQuery(CallbackQuery callbackQuery) {
        final String chatID = callbackQuery.getMessage().getChatId().toString();
        return messageService.getReplyMessage(chatID, "reply.query.STATS");
    }

    @Override
    public List<SendMessage> handleCallbackQueryMultiAnswer(CallbackQuery callbackQuery) {
        throw new NotImplementedException("handleCallbackQueryMultiAnswer not implemented in " + StatsByMatchIdCallbackQueryHandler.class);
    }
