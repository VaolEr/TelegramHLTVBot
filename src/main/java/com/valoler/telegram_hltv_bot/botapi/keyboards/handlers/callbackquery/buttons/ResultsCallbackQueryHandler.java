...
public class ResultsCallbackQueryHandler implements CallbackQueryHandler {

    private static final CallbackQueryType HANDLER_QUERY_TYPE = BotCallbackQueryType.RESULTS;
    ...
    public List<SendMessage> handleCallbackQueryMultiAnswer(CallbackQuery callbackQuery) {
        throw new NotImplementedException("handleCallbackQueryMultiAnswer not implemented in " + ResultsCallbackQueryHandler.class);
    }
